...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Contact Our Maryland Home Care Team | MarkoCare',
    description:
      'Request a free in-home care consultation in Maryland. MarkoCare serves Howard, Anne Arundel, Carroll & Frederick Counties. 24/7 coordination available.',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
        height: 630,
        alt: 'MarkoCare care coordinator speaking with a Maryland family about their home care options',
      },
    ],
  },
...
const reassuranceCards = [
  {
    ...
    desc: 'Our caregivers are carefully vetted, trained, and chosen for both their skills and their genuine warmth.',
  },
  {
    icon: Shield,
    title: 'Personalized Care Plans',
    desc: 'Every family receives an individualized care plan developed by a Registered Nurse — never a template.',
  },
  {
    icon: MapPin,
    title: 'Local Maryland Support',
    desc: 'We are locally based in Columbia, MD, serving families across Howard, Carroll, Anne Arundel, and Frederick Counties.',
  },
  {
    icon: MessageCircle,
    title: 'Responsive Communication',
    desc: 'Our care coordinators stay connected with families and are reachable when it matters most.',
  },
];
...
export default function ContactPage() {
  return (
    <>
      ...
      <section className="bg-mc-forest text-white py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="container-pad relative max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white leading-tight mb-5">
            We Are Here —{' '}
            <span className="text-mc-leaf-300 italic">Ready to Listen</span>
          </h1>

          <p className="text-lg text-white/75 leading-relaxed max-w-xl mb-10">
            Choosing home care is one of the most important decisions your family will make.
            Our care coordinators are here to guide you — with no pressure, no obligation,
            and no rush. Take the first step whenever you're ready.
          </p>
      ...
      {/* ══════════════════════════════════════════════════════════════════════
          §2  CONTACT OPTIONS — Clean information cards
      ══════════════════════════════════════════════════════════════════════ */}
        ...
        <div className="container-pad">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
            ...
            <div className="rounded-2xl border-2 border-mc-leaf-200 bg-mc-leaf-50 p-6 flex flex-col gap-3 shadow-premium hover:shadow-premium-lg hover:border-mc-leaf-300 transition-all duration-200">
              ...
              <div>
                <p className="text-[10px] font-bold uppercase tracking-widest text-mc-leaf-600 mb-1">
                  Phone — Priority
                </p>
                <a
                  href={`tel:${brand.phone}`}
                  className="text-xl font-bold text-mc-forest hover:text-mc-leaf-600 transition-colors block"
                >
                  {brand.phoneDisplay}
                </a>
            ...
            <div className="rounded-2xl border border-mc-stone bg-white p-6 flex flex-col gap-3 shadow-premium hover:shadow-premium-lg hover:border-mc-leaf-200 transition-all duration-200">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-sm font-semibold text-mc-forest hover:text-mc-leaf-600 transition-colors break-all"
                >
                  {brand.email}
                </a>
            ...
            <div className="rounded-2xl border border-mc-stone bg-white p-6 flex flex-col gap-3 shadow-premium hover:shadow-premium-lg hover:border-mc-leaf-200 transition-all duration-200 sm:col-span-2 lg:col-span-1">
              ...
              <div>
                ...
                <p className="text-xs text-mc-leaf-600 font-medium mt-1">
                  {brand.emergencyLine}
                </p>
              </div>
            </div>
      ...
      {/* ══════════════════════════════════════════════════════════════════════
          §3  ASSESSMENT FORM — Two-column layout
      ══════════════════════════════════════════════════════════════════════ */}
      <section id="assessment-form" className="py-20 md:py-28 bg-mc-sage">
        <div className="container-pad">
          <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] xl:grid-cols-[420px_1fr] gap-12 xl:gap-16 max-w-6xl mx-auto items-start">
            ...
            {/* ── LEFT: Contact summary + map ── */}
            <div className="space-y-5">
              <div>
                <span className="eyebrow mb-2 block">Ready to Talk?</span>
                <h2 className="text-2xl font-bold text-mc-forest leading-snug">
                  Contact Our Care Team
                </h2>
                <p className="text-sm text-gray-500 mt-2 leading-relaxed">
                  We are available Monday through Friday and maintain on-call support around
              ...
              <div className="rounded-2xl border border-mc-stone bg-white overflow-hidden shadow-premium">
                <div className="h-40 bg-mc-leaf-50 flex items-center justify-center relative">
                  ...
                  {[
                    ...
                    <div
                      key={i}
                      className="absolute rounded-full bg-mc-leaf-300 opacity-40"
                      style={{
                        width: dot.size,
                        height: dot.size,
                        top: dot.top,
      ...
      {/* ══════════════════════════════════════════════════════════════════════
          §4  REASSURANCE — Trust-building cards
      ══════════════════════════════════════════════════════════════════════ */}
      <section className="py-20 md:py-28 bg-white">
        <div className="container-pad">
          <div className="text-center max-w-xl mx-auto mb-12">
            <span className="eyebrow mb-3 block">Why Families Trust Us</span>
            <h2 className="text-3xl font-bold text-mc-forest">
              Care You Can Count On
            </h2>
            <p className="mt-3 text-gray-500 text-sm leading-relaxed">
              From the first phone call to every scheduled visit, we are committed to making
              this experience feel supported and clear.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {reassuranceCards.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="group rounded-2xl border border-mc-stone bg-white p-7 shadow-premium
                           hover:shadow-premium-lg hover:border-mc-leaf-200 hover:-translate-y-0.5 transition-all duration-200"
              >
                <div
                  className="w-12 h-12 rounded-2xl bg-mc-leaf-50 border border-mc-leaf-100
                              flex items-center justify-center mb-5
                              group-hover:bg-mc-leaf-500 group-hover:border-mc-leaf-500 transition-all duration-200"
                >
                  <Icon
                    className="h-5 w-5 text-mc-leaf-600 group-hover:text-white transition-colors duration-200"
                    aria-hidden="true"
                  />
                </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link href="/faq" className="btn-mc-outline text-sm">
                  View Full FAQ
                </Link>
      ...
      <section className="py-24 md:py-32 bg-mc-forest text-white relative overflow-hidden">
        ...
        <div className="container-pad relative">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-white/70 leading-relaxed text-[16px] mb-10 max-w-lg mx-auto">
              Whether you are ready to begin care or just exploring your options, we welcome
              your call. Our coordinators are here to answer questions honestly and help your
              family find the right path forward.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 mt-9 text-xs text-white/40">
              ...
              <span>✓ Care begins on your timeline</span>
            </div>
          </div>
        </div>
      </section>
